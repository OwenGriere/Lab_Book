...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.55\textwidth]{with_hist.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.55\textwidth]{ea2.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.55\textwidth]{hpr.png}
...
\[
HADDOCK_{score} = 1,0 * E_{vdw} + 0,2 * E_{elec} + 1,0 * E_{desol} + 0,1 * E_{air}
\]


le \(HADDOCK_{score}\) du Cluster 1 (meilleur classement) est de -163.9 +/- 9.3 tandis que le \(HADDOCK_{score}\) du Cluster 2,
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.55\textwidth]{allcluster.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.55\textwidth]{interface.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.55\textwidth]{cluster1.png}
  \caption{Visualisation de l'interface entre EA2 et HPR avec uniquement le cluster 1}
  \label{fig:interface}
\end{figure}

Je pense qu'on trouve de  meilleurs résultats pour la conformation du Cluster 1.
