...
On remarque que plus la température augmente plus il est compliqué pour la simulation d'atteindre les extremums d'énergie, ce qui relativement logique
compte tenu du modèle d'exclusion du critère de Metropolis.
