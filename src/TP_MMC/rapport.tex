...
\noindent Et voici un histogramme de la distribution de ces ecarts.
...
\noindent De plus, sur ces 1000 expériences de Métropolis Monte Carlo nous testons la précision de la méthode en définissant un seuil pour lequel on considère que 
la méthode a atteint la conformation la plus stable ce seuil est définit comme cela \(0{,}10 \cdot \mathrm{Min}_{\text{théorique}}\),
le critère est donc \(|\Delta E_{Théorique-Expérience}| \leq 0{,}10 \cdot \mathrm{Min}_{\text{théorique}}\)
