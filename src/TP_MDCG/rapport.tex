...
Les parametres sont placés dans un fichier JSON a coté. Ce qui permet de modifier les paramètres sans toucher au coeur du programme. Voici les paramètres qui composent
le champ de force : 
...
\begin{description}
  ...
  avec un rayon de coupure $r_{\mathrm{cut}} = 2.5\sigma$.
  
  \item[\textbf{Potentiel électrostatique}] 
  Traité implicitement ; l’effet du solvant est inclus dans les paramètres de Lennard–Jones.
