...
\begin{description}
  ...
  $K_{\mathrm{EL}} = 50$--$100~\mathrm{kcal \cdot mol^{-1} \cdot \AA^{-2}}$, 
  $R_{0} = 1.4$--$1.6~\mathrm{\AA}$ selon les liaisons (Ni–Ni, Ni–RIB, RIB–Pho).
  
  \item[\textbf{Potentiel de Lennard–Jones}] 
  $\epsilon = 0.15$--$0.25~\mathrm{kcal \cdot mol^{-1}}$, 
  $\sigma = 3.5$--$4.5~\mathrm{\AA}$.
