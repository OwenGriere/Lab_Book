...
\section{Fonctions pour le bottom-up}

Cette fonction sert a partir des fichier mapper et trouver le r0 en calculantcla médiane de chacune des liaisons pour chaque fichier
C'est le role de la fonction \texttt{bottom\_up} de creer un dictionnaire qui accumule toute les distances entre les liaisons ensute la fonction
