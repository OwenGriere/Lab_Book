...
\noindent On peut alors a la fin du main, dans le if final, choisir quel analyse nous voulons réaliser et avec quel paramètres. 
...
\noindent Ensuite on peut voir l'impact du nombre de pas grace à la heatmap ci-dessous qui montre de nouveau l'impact de la température et du nombre 
...
\noindent Pour finir, on regarde la même chose mais la condition d'acceptation d'une expérience de MMC est de trouver l'ensemble des puits au nombre de 6.
...
On remarque donc qu'il est bien plus facile de trouver la meilleur conformation que toute les conformations stables dont la meilleure. mais qu'il est possible d'atteindre un 
résultat satisfaisant en augmentant suffisament la température ainsi que le nombre de pas.

Pour conclure, la meilleur conformation de modèle gros grain dans ce champ de potentiel spécifique est la structure n°32. La MMC n'est pas évidente a mettre en place et le profil
